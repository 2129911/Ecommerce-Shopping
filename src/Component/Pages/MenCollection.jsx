...
import { mencollection } from "../../assets/MockData";
import video from '../../assets/Video/men.mp4'
...
const MenCollection = () => {
  ...
  useEffect(() => {
    dispatch(setProduct(mencollection)); 
  }, [dispatch]);
  ...
  <div className="relative z-10 bg-black bg-opacity-50 h-96 flex flex-col items-center justify-center text-center px-4 py-8">
    ...
    <h2 className="text-lg sm:text-2xl md:text-4xl font-bold text-white leading-tight">
      Welcome to{" "}
      <span className="text-red-500 animated-title">Men Collection's World</span>
    </h2>
